...
static struct pm8xxx_gpio_init pm8921_gpios[] __initdata = {
	...
	PM8XXX_GPIO_INIT(19, PM_GPIO_DIR_OUT, PM_GPIO_OUT_BUF_CMOS, 0, PM_GPIO_PULL_NO, \
			PM_GPIO_VIN_S4, PM_GPIO_STRENGTH_LOW, PM_GPIO_FUNC_NORMAL, 0, 0),
	PM8XXX_GPIO_INIT(20, PM_GPIO_DIR_OUT, PM_GPIO_OUT_BUF_CMOS, 0, PM_GPIO_PULL_NO, \
			PM_GPIO_VIN_S4, PM_GPIO_STRENGTH_LOW, PM_GPIO_FUNC_NORMAL, 0, 0),
	...
	PM8XXX_GPIO_INIT(24, PM_GPIO_DIR_IN, PM_GPIO_OUT_BUF_CMOS, 0, PM_GPIO_PULL_DN, \
			PM_GPIO_VIN_S4, PM_GPIO_STRENGTH_NO, PM_GPIO_FUNC_NORMAL, 0, 0),
	PM8XXX_GPIO_INIT(25, PM_GPIO_DIR_OUT, PM_GPIO_OUT_BUF_CMOS, 1, PM_GPIO_PULL_NO, \
			PM_GPIO_VIN_S4, PM_GPIO_STRENGTH_LOW, PM_GPIO_FUNC_NORMAL, 0, 0),
	...
	PM8XXX_GPIO_INIT(33, PM_GPIO_DIR_OUT, PM_GPIO_OUT_BUF_CMOS, 0, PM_GPIO_PULL_NO, \
			PM_GPIO_VIN_S4, PM_GPIO_STRENGTH_LOW, PM_GPIO_FUNC_NORMAL, 0, 0),
...
static struct pm8xxx_mpp_init pm8921_mpps[] __initdata = {
	...
	PM8XXX_MPP_INIT(5, A_OUTPUT,  PM8XXX_MPP_AOUT_LVL_1V25,   AOUT_CTRL_ENABLE),
	PM8XXX_MPP_INIT(6, A_OUTPUT,  PM8XXX_MPP_AOUT_LVL_1V25,   AOUT_CTRL_ENABLE),
