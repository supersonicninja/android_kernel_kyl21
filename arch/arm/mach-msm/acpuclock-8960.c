...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_slow[] = {
	...
	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(7),  1025000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(7),  1025000 },
	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(7),  1050000 },
	{ 1, {   702000, HFPLL, 1, 0, 0x1A }, L2(7),  1050000 },
	{ 0, {   756000, HFPLL, 1, 0, 0x1C }, L2(7),  1100000 },
	{ 1, {   810000, HFPLL, 1, 0, 0x1E }, L2(7),  1100000 },
	{ 0, {   864000, HFPLL, 1, 0, 0x20 }, L2(7),  1125000 },
	{ 1, {   918000, HFPLL, 1, 0, 0x22 }, L2(7),  1125000 },
	{ 0, {   972000, HFPLL, 1, 0, 0x24 }, L2(7),  1150000 },
	{ 1, {  1026000, HFPLL, 1, 0, 0x26 }, L2(7),  1150000 },
	{ 0, {  1080000, HFPLL, 1, 0, 0x28 }, L2(19), 1200000 },
	{ 1, {  1134000, HFPLL, 1, 0, 0x2A }, L2(19), 1200000 },
	{ 0, {  1188000, HFPLL, 1, 0, 0x2C }, L2(19), 1225000 },
	{ 1, {  1242000, HFPLL, 1, 0, 0x2E }, L2(19), 1225000 },
	{ 0, {  1296000, HFPLL, 1, 0, 0x30 }, L2(19), 1250000 },
	{ 1, {  1350000, HFPLL, 1, 0, 0x32 }, L2(19), 1250000 },
	{ 0, {  1404000, HFPLL, 1, 0, 0x34 }, L2(19), 1262500 },
	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(19), 1262500 },
...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_slow_384m[] = {
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   975000 },
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(1),   975000 },
	{ 0, { 0 } }
};
...
static struct acpu_level *acpu_freq_tbl_8960_v2_384m[NUM_PVS] __initdata = {
	[PVS_SLOW] = acpu_freq_tbl_8960_kraitv2_slow_384m,
	[PVS_NOM] = acpu_freq_tbl_8960_kraitv2_slow_384m,
	[PVS_FAST] = acpu_freq_tbl_8960_kraitv2_slow_384m,
};
...
static void __init select_freq_plan(void)
{
	...
	if (cpu_is_msm8960()) {
		...
		if (cpu_is_krait_v1()) {
			...
			if(boot_mode_charger){
				pr_err("Krait freq force to 384Mhz\n");
				acpu_freq_tbl = acpu_freq_tbl_8960_v2_384m[pvs_id];
