...
static struct gpiomux_setting sdc2_func_cfg = {
	.func = GPIOMUX_FUNC_1,
	.drv =  GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};

#define  SDC2_PORT_DAT0  89
#define  SDC2_PORT_DAT1  90
#define  SDC2_PORT_DAT2  91
#define  SDC2_PORT_DAT3  92
#define  SDC2_PORT_DAT4  93
#define  SDC2_PORT_DAT5  94
#define  SDC2_PORT_DAT6  95
#define  SDC2_PORT_DAT7  96
#define  SDC2_PORT_CMD   97
#define  SDC2_PORT_CLK   98

static struct msm_gpiomux_config sdc2_config_mux[] __initdata = {
	{
		.gpio      = SDC2_PORT_DAT0,
		.settings = {
			[GPIOMUX_ACTIVE] = &sdc2_func_cfg,
		},
	},
	{
		.gpio      = SDC2_PORT_DAT1,
...
#endif
    msm_gpiomux_install(sdc2_config_mux,
            ARRAY_SIZE(sdc2_config_mux));
