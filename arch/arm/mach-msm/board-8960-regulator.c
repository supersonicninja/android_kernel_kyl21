...
//	REGULATOR_SUPPLY("mipi_csi_vdd",	"2-0034"),
...
//	REGULATOR_SUPPLY("cam_vana",		"2-0034"),
...
//	REGULATOR_SUPPLY("cam_vaf",		"2-0034"),
...
//	REGULATOR_SUPPLY("cam_vio",		"2-0034"),
...
msm_pm8921_regulator_pdata[] __devinitdata = {
	...
	PM8XXX_NLDO1200(L28, "8921_l28", 0, 1, 375000, 1050000, 200, "8921_s7",
		0, 3),
	PM8XXX_LDO(L29,      "8921_l29", 0, 1, 1800000, 2200000, 200, "8921_s8",
		0, 4),
...
msm_rpm_regulator_init_data[] __devinitdata = {
	...
	RPM_LDO(L10,	 0, 1, 0, 3000000, 3300000, NULL,      0, 0),
	RPM_LDO(L11,	 0, 1, 0, 2700000, 3300000, NULL,      0, 0),
	RPM_LDO(L12,	 0, 1, 0, 1200000, 1450000, "8921_s4", 0, 0),
	RPM_LDO(L14,	 1, 1, 0, 1800000, 1800000, NULL,      0, 0),
	RPM_LDO(L15,	 0, 1, 0, 2850000, 2850000, NULL,      0, 0),
	RPM_LDO(L16,	 0, 1, 0, 2700000, 3300000, NULL,      0, 0),
	RPM_LDO(L17,	 1, 1, 0, 3000000, 3000000, NULL,      0, 0),
	RPM_LDO(L18,	 1, 1, 0, 1200000, 1200000, "8921_s4", 0, 0),
	RPM_LDO(L21,	 0, 1, 0, 1900000, 1900000, "8921_s8", 0, 0),
	RPM_LDO(L22,	 0, 0, 0, 2850000, 2850000, NULL,      0, 0),
	RPM_LDO(L23,	 1, 1, 1, 1800000, 1800000, "8921_s8", 10000, 10000),
	RPM_LDO(L24,	 0, 1, 1,  750000, 1150000, "8921_s1", 10000, 10000),
	RPM_LDO(L25,	 1, 1, 0, 1250000, 1250000, "8921_s1", 10000, 10000),
