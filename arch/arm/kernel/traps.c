...
static void dump_moderegs(void)
{
	struct mode_regs mode_regs;
	get_mode_regs(&mode_regs);
	printk(KERN_EMERG " svc: sp %08lx  lr %08lx  spsr %08lx\n",
	       mode_regs.sp_svc, mode_regs.lr_svc, mode_regs.spsr_svc);
	printk(KERN_EMERG " abt: sp %08lx  lr %08lx  spsr %08lx\n",
	       mode_regs.sp_abt, mode_regs.lr_abt, mode_regs.spsr_abt);
	printk(KERN_EMERG " und: sp %08lx  lr %08lx  spsr %08lx\n",
	       mode_regs.sp_und, mode_regs.lr_und, mode_regs.spsr_und);
	printk(KERN_EMERG " irq: sp %08lx  lr %08lx  spsr %08lx\n",
	       mode_regs.sp_irq, mode_regs.lr_irq, mode_regs.spsr_irq);
	printk(KERN_EMERG " fiq: r8 %08lx  r9 %08lx  r10 %08lx  r11 %08lx  "
			"r12 %08lx\n",
	       mode_regs.r8_fiq, mode_regs.r9_fiq, mode_regs.r10_fiq,
	       mode_regs.r11_fiq, mode_regs.r12_fiq);
	printk(KERN_EMERG " fiq: sp %08lx  lr %08lx  spsr %08lx\n",
