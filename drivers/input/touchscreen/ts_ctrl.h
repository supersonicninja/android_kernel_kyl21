...
#define IOCTL_LOAD_CHARGE_C_NV _IOW(IOC_MAGIC, 4, struct ts_nv_data)
#define IOCTL_LOAD_CHARGE_A_S1_NV _IOW(IOC_MAGIC, 5, struct ts_nv_data)
#define IOCTL_LOAD_CHARGE_A_S2_NV _IOW(IOC_MAGIC, 6, struct ts_nv_data)
#define IOCTL_LOAD_DISCHARGE_NV _IOW(IOC_MAGIC, 7, struct ts_nv_data)
